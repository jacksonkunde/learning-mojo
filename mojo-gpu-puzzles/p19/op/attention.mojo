...
struct AttentionCustomOp:
    ...
    fn execute[
        ...
        if target == "gpu":
            ...
            alias kernel3 = softmax_gpu_kernel[
                layout_scores,
                seq_len,
                dtype,
            ]
            ...
            alias final_matmul_kernel = matmul_idiomatic_tiled[
                layout_scores_2d,
                layout_v,
                layout_result_2d,
                1,
            ...
            gpu_ctx.enqueue_function_checked[final_matmul_kernel, final_matmul_kernel](
                result_2d,
                weights_2d,
                v_tensor,
