...
# Device configuration - use "mps" for Apple Silicon, "cuda" for NVIDIA, or "cpu"
DEVICE = "mps"
...
if __name__ == "__main__":
    ...
    indices = torch.randint(
        0, vocab_size, (batch_size, seq_len), device=DEVICE, dtype=torch.int32
    )

    embed_layer = torch.nn.Embedding(
        vocab_size, embed_dim, device=DEVICE, dtype=torch.float32
    )
